Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, inline: 'dnf -y --enablerepo=PowerTools install texinfo bison byacc flex json-c-devel systemd-devel git gawk make readline-devel net-snmp-devel pkgconfig pcre-devel libtool automake autoconf python3 python3-devel python3-sphinx python3-kobo-rpmlib rpm-build net-snmp-devel pam-devel libcap-devel'
