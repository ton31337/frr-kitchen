Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, inline: 'apt install build-essential libjson-c-dev python-dev libreadline-dev libc-ares-dev python-sphinx texinfo git autoconf libtool bison flex install-info python-pip realpath equivs groff fakeroot debhelper devscripts debhelper lintian systemd libpcre3-dev libpcre16-3 libpcre32-3 libpcrecpp0v5 pkg-config vim mininet iproute gdb libcap-dev -y'
  ...
  config.vm.provision :shell, inline: 'wget -O /root/libyang-dev_0.16.105-1_amd64.deb https://ci1.netdef.org/artifact/LIBYANG-YANGRELEASE/shared/build-10/Debian-AMD64-Packages/libyang-dev_0.16.105-1_amd64.deb'
  config.vm.provision :shell, inline: 'wget -O /root/libyang0.16_0.16.105-1_amd64.deb https://ci1.netdef.org/artifact/LIBYANG-YANGRELEASE/shared/build-10/Debian-AMD64-Packages/libyang0.16_0.16.105-1_amd64.deb'
  config.vm.provision :shell, inline: 'dpkg -i /root/libyang-dev_0.16.105-1_amd64.deb /root/libyang0.16_0.16.105-1_amd64.deb'
