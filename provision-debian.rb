Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, inline: 'apt update'
  config.vm.provision :shell, inline: 'apt install librtr0 librtr-dev build-essential libjson-c-dev python-dev python3.5-dev libreadline-dev libc-ares-dev python-sphinx texinfo git autoconf libtool bison flex install-info python-pip realpath equivs groff fakeroot debhelper devscripts debhelper lintian systemd libpcre3-dev libpcre16-3 libpcre32-3 libpcrecpp0v5 pkg-config vim mininet iproute gdb libcap-dev systemtap-sdt-dev -y'
