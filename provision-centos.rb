Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, inline: 'wget https://ci1.netdef.org/artifact/LIBYANG-YANGRELEASE/shared/build-10/CentOS-7-x86_64-Packages/libyang-0.16.111-0.x86_64.rpm'
  config.vm.provision :shell, inline: 'wget https://ci1.netdef.org/artifact/LIBYANG-YANGRELEASE/shared/build-10/CentOS-7-x86_64-Packages/libyang-devel-0.16.111-0.x86_64.rpm'
  config.vm.provision :shell, inline: 'rpm -i libyang-0.16.111-0.x86_64.rpm libyang-devel-0.16.111-0.x86_64.rpm'
